package com.iniyan.core.domain.preferences
...
// Solid Principles - Dependencies inversion principle - We should depends on abstraction and not on concentrations
